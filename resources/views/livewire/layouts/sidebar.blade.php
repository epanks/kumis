    ...
    <nav id="sidebar" aria-label="Main Navigation">
        ...
        <div class="content-header bg-white-5">
            ...
            <a class="font-w600 text-dual" href="index.html">
                ...
                <span class="smini-hide">
                    <span class="font-w700 font-size-h5">wfh-wilayah 3</span>
                </span>
            </a>
            <!-- END Logo -->
        ...
        <div class="content-side content-side-full">
            <ul class="nav-main">
                ...
                <li class="nav-main-heading">e-Programming</li>
                <li class="nav-main-item">
                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                        aria-expanded="false" href="#">
                ...
                <li class="nav-main-heading">Progres</li>
                <li class="nav-main-item">
                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                        aria-expanded="false" href="#">
                        <i class="nav-main-link-icon si si-wrench"></i>
                        <span class="nav-main-link-name">Progres</span>
                    </a>
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="/balailist">
                                <span class="nav-main-link-name">Balai</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="/paketlist">
