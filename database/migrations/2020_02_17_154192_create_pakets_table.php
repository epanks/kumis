...
class CreatePaketsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('paket', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('satoutput_id')->default(1)->nullable();
            $table->decimal('trgoutcome', 8, 2)->nullable();
            $table->unsignedBigInteger('satoutcome_id')->default(1)->nullable();
            ...
            $table->unsignedBigInteger('wilayah_id')->default(2)->nullable();
            $table->unsignedBigInteger('fnf_id')->default(1)->nullable();
            $table->unsignedBigInteger('ks_id')->default(1)->nullable();
            $table->unsignedBigInteger('apbnsbsn_id')->default(1)->nullable();
            $table->unsignedBigInteger('sycmyc_id')->default(1)->nullable();
